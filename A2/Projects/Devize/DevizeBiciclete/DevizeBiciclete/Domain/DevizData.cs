...
{
    public class DevizData : IEquatable<DevizData>
    {
        uint enters = 0;
        long numar=0;
        ...
        public float TotalFaraTVA { get { return TotalCuTVA - TotalCuTVA*TVA; } }
        public float TVA { get { if(tva > 1) return tva/100f; return tva; } set { tva = value; } }
        public float TVAdinTotal { get => TotalCuTVA * TVA; }
        public float TotalCuTVA { get { return TotalPiese + TotalManopera; } }
        ...
        public bool Equals(DevizData? other) => this == other;

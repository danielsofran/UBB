package app.template.orm.classparser;

import app.template.orm.annotations.*;
import app.template.orm.annotations.rules.Cascade;
import app.template.orm.annotations.rules.NoAction;
import app.template.orm.annotations.rules.SetNull;

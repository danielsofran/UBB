package com.example.temalab3.ui;

import com.example.temalab3.HelloApplication;
...
public class GUIMaker {
    public static void openNewWindow(String fxml, String title, Consumer<FXMLLoader> controllerSetter) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getClassLoader().getResource(fxml));

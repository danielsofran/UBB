...
int main(int argc, char* argv[])
{
	...
	const string inputFile = "C:/Users/aerap/Desktop/PPD/lab3/tema1J/data.txt";
	...
	if (myid == 0) {
		const string outputFile = "C:/Users/aerap/Desktop/PPD/lab3/tema1J/outMPI.txt";
		...
		const string truthFile = "C:/Users/aerap/Desktop/PPD/lab3/tema1J/outSecvential.txt";
...
//				finOut >> y;
//				if (x != y)
//					cerr << "Items not equal at: " << i << "," << j << ": " << x << " != " << y << '\n';
//				//assert(x == y);
//			}
//		}
//

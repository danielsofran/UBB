...
public class Main {
    ...
    static String input = "C:\\Users\\aerap\\Desktop\\PPD\\lab4\\prjava\\data.txt";
    static String outSecvential = "C:\\Users\\aerap\\Desktop\\PPD\\lab4\\prjava\\outSecvential.txt";
    static String outThreadsLine = "C:\\Users\\aerap\\Desktop\\PPD\\lab4\\prjava\\outThreadsLine.txt";

    public static void main(String[] args) throws IOException {
        generateRandomData(1000, 1000, 5000);
    ...
    public static void runStaticLine(int n, int m, int[][] A, int[][] C) {
        ...
        writeMatrixToFile(outSecvential, A);
    }
    ...
    private static void solveThreadsLine(int n, int m, int[][] A, int[][] C, int p) {
        ...
        int[][] AA;
        AA = new int[n + 2][m + 2];
        readMatrixFromFile(outSecvential, n + 2, m + 2, AA);
    ...
    public static void runThreadsLine(int n, int m, int[][] A, int[][] C, int p) {
        ...
        writeMatrixToFile(outThreadsLine, A);
    }

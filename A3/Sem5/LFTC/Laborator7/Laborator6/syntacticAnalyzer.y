...
instr: assigment SEMICOLON | if_stmt | cyclic_stmt | io_stmt SEMICOLON | RETURN INT SEMICOLON | paranteze
...
operand: INT | MULTIPLY_OPERATOR
operanzi: operand | operand operanzi
paranteze: paranteza | paranteze operanzi paranteza
paranteza: PARENTHESIS_O operanzi PARENTHESIS_C
			| PARENTHESIS_O operanzi paranteze PARENTHESIS_C
			| PARENTHESIS_O paranteze operanzi PARENTHESIS_C
			| PARENTHESIS_O paranteze PARENTHESIS_C
%%

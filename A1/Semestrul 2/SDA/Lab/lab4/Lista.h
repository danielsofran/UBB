...
public:
	...
	TElem element(IteratorLP<TElem> poz) const{
        /* de adaugat */
        return poz.element();
    }
	...
	//arunca exceptie daca poz nu e valid
	TElem modifica(IteratorLP<TElem> poz, TElem e){
        /* de adaugat */
        if (!poz.valid())
            throw std::exception();
	...
	// elementul adaugat
	//arunca exceptie daca poz nu e valid
	void adauga(IteratorLP<TElem>& poz, TElem e){
        /* de adaugat */
	...
	TElem sterge(IteratorLP<TElem>& poz){
        /* de adaugat */
        if (!poz.valid())
            throw std::exception();
        TElem elem = elements[poz.indice];
	...
	IteratorLP<TElem> cauta(TElem e) const{
        /* de adaugat */
